...
public class ReminderController {
	...
	public ResponseEntity saveReminder(@RequestBody Reminder reminder){
		try{
			responseEntity = new ResponseEntity(reminderService.createReminder(reminder), HttpStatus.CREATED);
	...
	public ResponseEntity deleteReminder(@PathVariable("id") String id){
		try{
			Boolean category = reminderService.deleteReminder(id);
	...
	public ResponseEntity getReminderById(@PathVariable("id") String id){
		try{
			responseEntity = new ResponseEntity(reminderService.getReminderById(id),HttpStatus.OK);
		} catch (ReminderNotFoundException e) {
			responseEntity = new ResponseEntity(e.getMessage(),HttpStatus.NOT_FOUND);
		}
		return responseEntity;
	...
	public ResponseEntity getAllReminders(){
		try{
			responseEntity = new ResponseEntity(reminderService.getAllReminders(),HttpStatus.OK);
		} catch (Exception e) {
			responseEntity = new ResponseEntity(e.getMessage(),HttpStatus.NOT_FOUND);
		}
		return responseEntity;
