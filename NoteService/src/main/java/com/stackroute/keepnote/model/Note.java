...
public class Note {
	...
	public Note(int noteId, String noteTitle, String noteContent, String noteStatus, Date noteCreationDate, String noteCreatedBy, Category category, List<Reminder> reminders) {
		this.noteId = noteId;
