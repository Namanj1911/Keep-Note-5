...
public class UserAuthenticationController {
	...
	public ResponseEntity createUser(@RequestBody User user) {
		try {
			if (authenticationService.saveUser(user)) {
	...
	public ResponseEntity validateUser(@RequestBody User user) {
		try {
			if (authenticationService.findByUserIdAndPassword(user.getUserId(), user.getUserPassword()) != null) {
	...
	public String getToken(String username, String password) throws Exception {
        ...
        boolean flag = authenticationService.validateUser(username, password);
        if (!flag) {
            throw new UserIdAndPasswordMismatchException("Wrong credentials");
        } else {
