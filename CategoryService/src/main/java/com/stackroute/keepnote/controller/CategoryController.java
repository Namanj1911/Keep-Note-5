...
public class CategoryController {
	...
	public ResponseEntity<?> updateCategory(@RequestBody Category category, @PathVariable("id") String id) {
		if (categoryService.updateCategory(category, id) != null) {
			responseEntity = new ResponseEntity(categoryService.updateCategory(category, id), HttpStatus.OK);
		} else {
			responseEntity = new ResponseEntity("Could Not Update", HttpStatus.CONFLICT);
		}
		return responseEntity;
	}
	...
	public ResponseEntity<?> getCategoryById(@PathVariable("id") String id) {
		try {
			...
			responseEntity = new ResponseEntity(cat, HttpStatus.OK);
